...
description: "Cryptographically verify the SuprSend CLI binary using Cosign and checksums before installing to confirm authenticity and prevent tampering."
keywords:
  - suprsend cli verify
