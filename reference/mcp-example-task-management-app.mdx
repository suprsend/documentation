...
tag: "REACT"
description: "Build a Kanban task management board with React, Vite, OTP login, and SuprSend inbox and preference center using ready-made AI prompts."
---
...
### 3a. Create preference categories

Set up your [preference categories](/docs/managing-notification-categories) with root **Task Management** and sub-categories. **Publish** the structure.
