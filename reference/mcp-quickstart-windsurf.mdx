...
description: "Connect the SuprSend MCP server to Windsurf with a service token and npx configuration so the AI editor can drive workflows, users, and templates."
---
