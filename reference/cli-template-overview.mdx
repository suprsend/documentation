...
description: "Overview of suprsend template CLI commands to list, get, pull, push, and commit notification templates and their channel variants between workspaces."
keywords: ["suprsend template cli", "manage templates suprsend", "suprsend template list push pull", "suprsend cli template reference"]
---
