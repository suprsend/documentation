---
title: "Pull Template"
description: "Pull notification templates and all channel variants from a SuprSend workspace into local files you can edit and push back using the template pull command."
keywords:
