...
tag: "REACT"
description: "Build a status page app with React, Vite, and SuprSend subscriptions using ready-made AI prompts to scaffold UI, categories, and notifications."
---
...
Set up your [preference categories](/docs/managing-notification-categories) using the **root category → section → sub-category** structure. Create one root category (e.g. "Status updates"), then add sections and sub-categories under it. **Publish** the structure.
