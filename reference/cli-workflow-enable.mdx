---
title: "Enable a workflow with the SuprSend CLI"
sidebarTitle: "Enable Workflow"
description: "Use the suprsend workflow enable command to activate a SuprSend workflow so it runs when triggered by events, the workflow API, or scheduled broadcasts."
keywords:
