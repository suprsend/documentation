---
title: "Commit Schema"
description: "Promote a trigger payload schema from draft to live in a SuprSend workspace using the suprsend schema commit command with a schema slug argument."
keywords: ["suprsend schema commit", "commit schema suprsend", "suprsend cli schema", "suprsend cli reference", "version control schema promotions"]
---
