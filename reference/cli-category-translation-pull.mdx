---
title: "Pull Preference Translation"
description: "Use the suprsend category translation pull CLI command to download preference category translation JSON files for each locale from your workspace."
keywords:
