---
title: "Pull Translation"
description: "Download template translation files from a SuprSend workspace into local JSON files, one per locale, using the suprsend translation pull CLI command."
keywords:
