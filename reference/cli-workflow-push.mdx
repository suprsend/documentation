---
title: "Push workflows with the SuprSend CLI"
sidebarTitle: "Push Workflow"
description: "Use the suprsend workflow push command to promote SuprSend workflows from your local directory to a workspace, enabling Git-based version control and sync."
keywords:
