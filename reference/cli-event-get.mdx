---
title: "Get Event"
description: "Use the suprsend event get CLI command to retrieve all events and their schema mappings from a workspace, including names, descriptions, and payloads."
keywords:
  - suprsend event get
