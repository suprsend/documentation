---
title: "Global Flags"
description: "Reference for global flags in the SuprSend CLI like config, workspace, service token, output, and verbosity available with every suprsend command."
keywords:
  - suprsend cli flags
