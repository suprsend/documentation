...
description: "Generate shell autocompletion scripts for the SuprSend CLI in bash, zsh, fish, or PowerShell so you can tab-complete commands and flags without typos."
keywords:
