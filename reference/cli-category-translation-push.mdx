...
description: "Use the suprsend category translation push CLI command to upload locale JSON files for preference categories to your workspace, one locale or all at once."
