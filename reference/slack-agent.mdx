...
tag: "BETA"
description: "Manage users, workflows, preferences, and analytics from Slack, with a Privacy Filter that keeps PII out of shared channels."
---
...
It's designed for teams that share a Slack workspace but care about who sees what. The Privacy Filter keeps PII out of shared channels by default, and the whole AI layer is optional: if your organization can't share data with third-party model providers, an admin can turn off every AI feature in one click, and the rest of SuprSend (workflows, templates, channels, preferences, delivery, analytics) keeps working unchanged.
...
Manage the Slack App from **Account Settings → [AI & Agents](https://app.suprsend.com/en/account-settings/ai-agents)**, the same page as the dashboard Agent. From there you can:
