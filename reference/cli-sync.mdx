---
title: "Sync Assets"
description: "Sync SuprSend assets from one workspace to another"
keywords:
  - suprsend sync
...
|------|-------------|---------|
| `-a, --assets string` | Asset types to sync: all, workflow, schema, event, category, or translation | `all` |
