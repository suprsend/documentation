...
description: "Promote template translation changes from draft to live across a SuprSend workspace using the suprsend translation commit CLI command for localization."
keywords: ["suprsend translation commit", "commit translations suprsend", "suprsend cli translations", "commit translation changes", "suprsend cli reference"]
---
