---
title: "List Event"
description: "Use the suprsend event list CLI command to view all events in a workspace with pagination, including event names and linked schema information."
keywords:
  - suprsend event list
