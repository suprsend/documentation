...
description: "Learn how to authenticate SuprSend HTTP API requests using workspace API keys, including where to find them in the dashboard and how to use them safely."
---
