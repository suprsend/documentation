...
description: "Retrieve all template translation content keyed by locale code from a SuprSend workspace for draft or live mode using the translation get command."
keywords: ["suprsend translation get", "suprsend cli translation details", "get template translations", "suprsend cli reference"]
---
