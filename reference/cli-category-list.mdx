---
title: "List Category"
description: "Use the suprsend category list CLI command to view preference categories in a workspace as a flat table with root, section, and channel details."
keywords:
