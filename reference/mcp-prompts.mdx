...
description: "Copy-paste prompt cheatsheet for SuprSend tasks like creating workflows, managing users, and sending notifications from any MCP-connected AI client."
---
