...
description: "All available tools in the SuprSend MCP server, organized by category."
---

<Note>
  All tools listed here are also available in the SuprSend Agent on the dashboard.
</Note>
