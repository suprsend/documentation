...
| `tenants.update_preferences` | Update a tenant's preference overrides for a category | [Update Tenant Preference](https://docs.suprsend.com/reference/update-tenant-preference-single-category.md) |
