...
2. The right support channel for each kind of question - SuprSend Agent, in-app chat, Slack, or email.
...
|---|---|---|
| **SuprSend Agent** | [app.suprsend.com](https://app.suprsend.com) - orb bottom-right (`Cmd+/` / `Ctrl+/`) | Instant answers, debugging inside the dashboard |
