...
2. The right support channel for each kind of question - Agent, in-app chat, Slack, or email.
...
|---|---|---|
| **Agent** | [app.suprsend.com](https://app.suprsend.com) - orb bottom-right (`Cmd+/` / `Ctrl+/`) | Instant answers, debugging inside the dashboard |
