---
title: "Get Template"
description: "Retrieve a notification template by slug from a SuprSend workspace with all channel variants, targeting conditions, and mock data for draft or live."
keywords:
