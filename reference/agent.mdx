...
sidebarTitle: "Agent"
tag: "BETA"
description: "Use SuprSend Agent in the dashboard to query your workspace, draft workflows, and debug notification delivery using a plain English chat interface."
---
