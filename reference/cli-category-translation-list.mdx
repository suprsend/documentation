...
description: "Use the suprsend category translation list CLI command to view available locale codes that have preference category translations configured in a workspace."
keywords:
