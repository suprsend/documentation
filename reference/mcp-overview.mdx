...
<Note>
  On **Claude Code** or **VS Code Copilot**? Skip the manual setup and install the [SuprSend Agent Plugin](/reference/agent-plugin) — it bundles the MCP server with all SuprSend Skills in a single command.
</Note>
