...
Manage CLI profiles for switching between different servers or accounts. Profiles are primarily useful for **self-hosted and BYOC deployments** — SaaS users can authenticate using environment variables or command-line flags instead.
