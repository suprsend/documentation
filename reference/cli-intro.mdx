...
<Note>
**Beta Feature** - The SuprSend CLI is in active development. Features may change or have limitations.
</Note>
...
| [`schema commit`](/reference/cli-schema-commit) | Commit schema to make it live |
...
Manage [sync](/reference/cli-sync): sync assets between workspaces. Also, see <Link href="/reference/cli-sync">Sync Management APIs</Link>.
