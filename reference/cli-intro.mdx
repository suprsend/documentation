...
<Note>
**The SuprSend CLI is currently in beta**  
> We’re actively improving and expanding commands and flags based on developer feedback.  
> If you run into any issues, please let us know by creating an issue on [GitHub](https://github.com/suprsend/cli/issues).  
> The CLI is open source—so feel free to contribute to the project.
</Note>
...
Manage [profiles](/docs/profiles): create, update, list, and promote across workspaces. Also, see <Link href="/reference/create-update-profile">Profile Management APIs</Link>.
...
### Schema
Manage [schemas](/docs/schemas): create, update, commit, reset, and promote across workspaces. Also, see <Link href="/reference/create-update-schema">Schema Management APIs</Link>.  
...
| [`schema reset`](/reference/cli-schema-reset) | Reset schema to previous version |
...
Manage [categories](/docs/categories): create, update, list, and promote across workspaces. Also, see <Link href="/reference/create-update-category">Category Management APIs</Link>. 
...
Manage [sync](/docs/sync): sync assets between workspaces. Also, see <Link href="/reference/create-update-sync">Sync Management APIs</Link>.
