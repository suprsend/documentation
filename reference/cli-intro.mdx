---
title: "CLI Overview"
description: "Overview of the SuprSend CLI for managing workflows, templates, schemas, and events, syncing assets across workspaces, and building notification CI/CD."
keywords:
...
Manage [events](/docs/events): create, update, list, and promote across workspaces. Also, see <Link href="/reference/create-event">Event Management APIs</Link>.
...
Manage [translations](/docs/translations): create, update, list, and promote across workspaces. Also, see <Link href="/reference/add-translation">Translation Management APIs</Link>.
