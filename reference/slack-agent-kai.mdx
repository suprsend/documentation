...
1. **Install the Slack App** for your workspace from **Account Settings → AI & Agents** ([app.suprsend.com/en/account-settings/ai-agents](https://app.suprsend.com/en/account-settings/ai-agents)). Your SuprSend admin can share the install link.
...
Manage the Slack App from **Account Settings → AI & Agents** ([app.suprsend.com/en/account-settings/ai-agents](https://app.suprsend.com/en/account-settings/ai-agents)) — same page as the dashboard Agent. From there you can:
