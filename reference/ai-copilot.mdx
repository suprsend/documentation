...
<Warning>
  SuprSend Agent is in **beta**. It's currently free - no usage limits, no charges. We'll announce pricing before moving to general availability.
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="Design and test notifications" icon="paper-plane">
  ...
  <Card title="Debug and inspect delivery" icon="bug">
