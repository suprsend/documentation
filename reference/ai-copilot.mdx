...
<Warning>
  Agent is in **beta**. Pricing and limits may change before general availability — see **AI & Agents** in settings for live credit usage.
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="Translate content" icon="language">
    Update English; Agent translates locale files into every configured language and commits them.
  </Card>
</CardGroup>
...
Manage Agent from **Account Settings → AI & Agents** ([app.suprsend.com/en/account-settings/ai-agents](https://app.suprsend.com/en/account-settings/ai-agents)). Same page controls the Slack App and shows credit usage.
