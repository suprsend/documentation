...
You'll need a service token from SuprSend to authenticate with SuprSend:
...
Alternatively, you can also pass the service token as a command flag in your MCP configuration.
```json
  {
    "mcpServers": {
      "suprsend": {
...
1. Open Cursor Settings → Developer Section.
