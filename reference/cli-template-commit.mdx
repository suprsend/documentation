...
description: "Commit a notification template's draft to live in a SuprSend workspace using the suprsend template commit CLI command with the template slug argument."
keywords: ["suprsend template commit", "commit template suprsend", "suprsend cli templates", "suprsend cli reference", "publish template suprsend"]
---
...
| --- | --- |
| `<slug>` | The slug of the template to commit _(required)_ |
