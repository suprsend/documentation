---
title: "Pull Schema"
description: "Download trigger payload schema definitions from a SuprSend workspace into local JSON files, one per slug, using the suprsend schema pull command."
keywords:
