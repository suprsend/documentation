...
description: "Explore SuprSend AI-native interfaces including the MCP server, Agent SDK, and Agent Skills to build, manage, and trigger notifications without boilerplate."
---
...
<CardGroup cols={3}>
  ...
  <Card title="Agent Plugin" icon="plug" iconType="solid" href="/reference/agent-plugin">
