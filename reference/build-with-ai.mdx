...
<CardGroup cols={3}>
  ...
  <Card title="Agent Plugin" icon="plug" iconType="solid" href="/reference/agent-plugin-setup">
...
<CardGroup cols={2}>
  ...
  <Card title="Agent Plugin Setup" icon="plug" iconType="solid" href="/reference/agent-plugin-setup">
  ...
  <Card title="Slack Agent" icon="slack" iconType="solid" href="/reference/slack-agent">
