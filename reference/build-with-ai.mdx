...
<CardGroup cols={2}>
  ...
  <Card title="Kai (Slack)" icon="slack" iconType="solid" href="/reference/slack-agent-kai">
    Use @Suprsend-Kai in DM or #kai-test to manage users, workflows, preferences, and analytics from Slack.
  </Card>
</CardGroup>
