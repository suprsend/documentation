...
<CardGroup cols={2}>
  <Card title="Agent Plugin" icon="puzzle-piece" iconType="solid" href="/reference/agent-plugin">
    One-line install for Claude Code and VS Code Copilot. Bundles Skills + the MCP server so your agent gets schema knowledge and live tools in a single step.
  </Card>
  <Card title="MCP Server" icon="server" iconType="solid" href="/reference/mcp-overview">
    Connect any MCP-compatible IDE to SuprSend. Query docs, trigger workflows, manage users — all through tool calling.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Agent Plugin (Claude Code + VS Code)" icon="puzzle-piece" iconType="solid" href="/reference/agent-plugin">
    Recommended for Claude Code and VS Code Copilot. One command installs Skills and the MCP server together.
  </Card>
  ...
  <Card title="MCP Quickstart — Claude" icon="comments" iconType="solid" href="/reference/mcp-quickstart-claude">
    Connect the MCP server to Claude Desktop, or use the plugin for Claude Code.
  </Card>
