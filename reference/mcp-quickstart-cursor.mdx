...
sidebarTitle: "Cursor"
description: "Connect the SuprSend MCP server to Cursor with a service token and npx-based configuration so your AI editor can manage workflows and users."
---
