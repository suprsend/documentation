---
title: "List Schema"
description: "List trigger payload schemas in a SuprSend workspace with pagination, returning slug, name, and version for draft or live mode via the schema list command."
keywords:
