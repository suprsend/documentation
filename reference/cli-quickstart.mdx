---
title: "Quickstart"
description: "Quickstart guide to install the SuprSend CLI, authenticate with a service token, configure a workspace, and run your first commands in minutes."
keywords: ["suprsend cli quickstart", "cli installation", "cli authentication", "cli first steps", "suprsend command line", "cli tutorial", "cli getting started", "npx suprsend"]
---
