...
description: "Overview of suprsend schema CLI commands to list, get, pull, push, and commit trigger payload schemas that validate workflow and event payloads."
keywords: ["suprsend schema", "suprsend validate workflow payload", "schema cli suprsend"]
---
