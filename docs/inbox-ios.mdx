---
title: "iOS (Headless)"
description: "Integrate the SuprSend Inbox in your iOS app using the native headless SDK to fetch notifications, mark as read, and build your own custom Swift inbox UI."
---
