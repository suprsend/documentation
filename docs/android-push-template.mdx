...
description: "How to design advanced Android Push template with customisation options to send silent, sticky notifications, and more."
---
...
| App icon (Small icon) | Single line Text | Small icon name without extension. The small icon is displayed on the top status bar and on the left side of notification header. By default SuprSend will show a bell icon, however you can customize this to [show your app icon](/docs/android-push-template#how-to-change-the-small-icon-for-a-notification%3F) instead.                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| Sound                 | Single line Text | Sound file name without extension or with extension. This is used to play custom sound on notification delivery. If left blank, the default notification sound of the device will be played. To set custom sound, you'll have to [add raw sound file](/docs/android-push-template#how-to-add-a-custom-sound-file-in-your-android-project%3F) in your android app folder                                                                                                                                                                                                                                                                                                                                                                                                            |
...
<Steps>
  ...
  <Step title="Using variables in the templates:">
    ...
    * Make sure you have entered the correct variable name in the template, as per the `handlebars` guideline.
    ...
    <Frame>
      <img src="/images/docs/340affd-Screenshot_2021-11-20_at_6.54.59_PM.png" />
    </Frame>
...
<Accordion title="Option B. Adding a png icon for small icon" defaultOpen={false}>
  ...
  <Steps>
    ...
    <Step title="Create project paths">
      ...
      <Frame>
        <img src="/images/docs/a1392cc-Frame_57_2.png" />
      </Frame>
...
<Info>
  ...
  E.g.- notification.mp3, notificationMusic.mp3,notification\_music.mp3
</Info>

<Frame>
  <img src="/images/docs/470248c-sound_file.png" />
</Frame>
