...
description: "Explanatory guide on automating User & List synchronization from your database with SQL queries."
---
...
<Steps>
  ...
  <Step title="Save query and commit to setup sync frequency">
    Once you are satisfi - ed with your query results, `Save query` and `Commmit changes` it. You'll see sync settings on commit.
