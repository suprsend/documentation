...
Go to **Lists → + New List** and set a `list_id` (required — unique within the workspace; lowercase letters, digits, hyphens, and underscores only), plus an optional name and description.
