---
title: "Create, Update, and Delete Tenants in the Dashboard"
description: "Manage tenants from the SuprSend dashboard or backend SDKs to configure branding, vendors, templates, and preferences for each customer or brand."
---
