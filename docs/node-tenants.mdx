---
title: "Create and Manage Tenants with the Node.js SDK"
description: "Create, update, fetch, list, and delete tenants programmatically using the SuprSend Node.js SDK to power multi-tenant notification flows."
---
