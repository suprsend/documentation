---
title: "Tenants"
description: "Use the SuprSend NodeJS SDK to create, update, fetch, and list tenants for whitelabeling notifications and personalizing content per organization."
---
...
| Field                                 | Description                                                                                                                                                               |
| :------------------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| tenant_id (mandatory)                 | max 64 characters and can contain lowercase letters (a-z), digits (0-9), dot (.), hyphen (-), and underscore (_) — matching `[a-z0-9_.-]`.                                                                    |
