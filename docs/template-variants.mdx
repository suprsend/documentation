...
description: "Use SuprSend template variants to serve different content by tenant, language, or condition from a single template, with default fallback and live preview."
---
