---
title: "Slack"
description: "Design Slack notification templates using the Text editor for simple messages or the JSONNET editor for rich Block Kit layouts."
---
...
**Text mode** — the right panel shows a live Slack message preview, updated as you type.

**JSONNET mode** — click **View on Slack Builder** to render and validate your Block Kit output in Slack's [Block Kit Builder](https://app.slack.com/block-kit-builder/).
