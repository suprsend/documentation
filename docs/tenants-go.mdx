---
title: "Tenants"
description: "Create, update, fetch, and list SuprSend tenants from your backend using the Go SDK, with code samples for white-labeling and per-tenant personalization."
---
