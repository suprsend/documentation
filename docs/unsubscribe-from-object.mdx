...
description: "Use the unsubscribe from object node to dynamically remove recipients from an object subscription inside a workflow based on events, conditions, or actions."
---
...
<Frame>
  <img src="/images/docs/08caf8e3b34db52b25b0b31495c6eddfefab90c5047c148c18eea381bd192507-image.png" />
</Frame>
