...
description: "Integrate the SuprSend JavaScript Web SDK to enable WebPush, preferences, and In-app feed across React, Vue, Next.js, and other modern web frameworks."
---
