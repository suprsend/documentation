...
description: "Learn how to override the default workflow recipient in trigger nodes so you can route notifications to specific users or groups based on event properties."
---
