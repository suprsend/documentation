...
description: "Use the data transform node in SuprSend workflows to generate or modify variables on the fly based on input data, conditions, and prior workflow step outputs."
---
...
<Frame>
  <img src="/images/docs/a72da80-image.png" />
</Frame>
