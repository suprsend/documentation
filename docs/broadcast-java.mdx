---
title: "Send broadcast notifications with the Java SDK"
sidebarTitle: "Broadcast"
description: "Use the SuprSend Java SDK to send broadcast notifications to a list of subscribers, with code examples for setting up the broadcast request and payload."
---
