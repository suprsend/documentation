...
description: "Validate the data passed to the workflow API and event properties against JSON schemas to catch payload mismatch errors at the API level before delivery."
---
...
- Inconsistent behavior (for example, first notification fails but subsequent steps succeed).
