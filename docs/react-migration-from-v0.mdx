...
description: "Upgrade the SuprSend React SDK between major versions with this migration guide."
---

# Migrating to v1 from v0

The only change v1 introduces is tenant scoping across the sdk.
