...
4. **Test Notifications**: Create your first workflow and send a test notification from the dashboard or API to test a notification flow.
...
<Card title="Download Test Sheet" icon="download" iconType="solid" href="/images/SuprSend%20Self-hosted%20Installation_%20Checklist.xlsx">
