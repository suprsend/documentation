---
title: "Quick Start"
description: "Deploy SuprSend self-hosted on your infrastructure with this quick start covering PostgreSQL, Redis, dependencies, Helm install, and post-setup checks."
---
