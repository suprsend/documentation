---
title: "Changelog"
description: "Track SuprSend self-hosted release notes including Helm chart updates, new features, security patches, bug fixes, and upgrade instructions per version."
---
...
<AccordionGroup>
  <Accordion title="v1.2.4 (Jul 2026) — Latest" icon="tag" iconType="solid">
    **Release Date:** July 6, 2026  
    **Docker Tag:** `suprsend@1.2.4`

    #### Product updates
    - **True multitenancy for user category preferences** — fully scoped to `tenant_id` / `workspace_uid`
    - **Multiple iOS apps support** — send to different Bundle IDs within the same iospush channel
    - **New SMTP Email Vendor** — flexible email delivery through any custom SMTP provider
    - **Messages API** — fetch messages and update status (seen, read, archived, etc.) programmatically
    - **Message Content Preview** — view the exact final rendered message that will be delivered to recipients
    - **Cancel running workflows & broadcasts** — stop in-progress campaigns and workflows on demand
    - **Preference Category Enhancements:**
      - Digest schedules at the category level
      - Custom properties for advanced preference conditions
    - **FCM Native Payload Support** — send Android push notifications directly via FCM without requiring SDK integration

    #### Bugfixes and improvements
    - Stability & Reliability — numerous performance improvements, bug fixes, and edge-case handling
  </Accordion>

  <Accordion title="v1.2.3 (Jun 2026)" icon="tag" iconType="solid">
    **Release Date:** June 15, 2026  
    **Docker Tag:** `suprsend@1.2.3`
  </Accordion>

  <Accordion title="v1.2.2 (Jun 2026)" icon="tag" iconType="solid">
    **Release Date:** June 11, 2026  
    **Docker Tag:** `suprsend@1.2.2`  
    **Status:** Deprecated
  </Accordion>

  <Accordion title="v1.2.1 (May 2026)" icon="tag" iconType="solid">
    **Release Date:** May 13, 2026  
    **Docker Tag:** `suprsend@1.2.1`  
    **Status:** Deprecated
  </Accordion>

  <Accordion title="v1.2.0 (Apr 2026)" icon="tag" iconType="solid">
    **Release Date:** April 25, 2026  
    **Docker Tag:** `suprsend@1.2.0`  
    **Status:** Deprecated
  </Accordion>

  <Accordion title="v1.1.9 (Apr 2026)" icon="tag" iconType="solid">
    **Release Date:** April 16, 2026  
    **Docker Tag:** `suprsend@1.1.9`  
    **Status:** Deprecated
  </Accordion>

  <Accordion title="v1.1.2 (Feb 2026)" icon="tag" iconType="solid">
    **Release Date:** February 10, 2026  
    **Docker Tag:** `suprsend@1.1.2`
  </Accordion>
  ...
  <Accordion title="v1.0.6 (June 2025)" icon="tag" iconType="solid">
    ...
    **Helm Chart Version:** `1.0.6`
    ...
    #### Dashboard updates
    - **Preference tags:** Filter preference categories by tags (e.g. role, team, department)
  ...
  <Accordion title="v1.0.1 (Feb 2025) - Initial GA Release" icon="tag" iconType="solid">
    ...
    **Status:** Deprecated
    ...
    - **Inbox 2.0 (In-App)**: JWT-based authentication, with multi-tab, translation, tenant-level feed and seen/click tracking
