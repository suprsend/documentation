---
title: "Changelog"
description: "Track SuprSend Self-Hosted (BYOC) releases, including new features, fixes, and upgrade instructions."
keywords: ["BYOC changelog", "self-hosted releases", "Helm chart", "version history", "upgrade instructions"]
---

The SuprSend Self-Hosted (BYOC) Changelog provides a record of all self-hosted releases, including new features, bug fixes, and infrastructure updates for the Helm chart and related components.
