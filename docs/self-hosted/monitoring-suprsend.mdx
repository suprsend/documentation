...
description: "Set up Prometheus, Grafana, and Loki on Kubernetes to monitor metrics, dashboards, and logs for your self-hosted SuprSend deployment across services."
---
