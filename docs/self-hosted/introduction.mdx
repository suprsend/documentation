...
<Frame caption="SuprSend self-hosted architecture">
  <div style={{textAlign: 'center'}}>
    <img src="/images/suprsend-self-hosted-architecture.png" alt="SuprSend Self-Hosted Architecture" style={{maxWidth: '100%', height: 'auto', borderRadius: '8px'}} />
  </div>
</Frame>
...
| [WorkOS](https://workos.com) (optional) | — | For enterprise SSO, SAML, and social logins. See [setup guide](/docs/self-hosted/workos-integration) |
...
## Support Channels
- Community Support: [Slack Community](https://suprsendcommunity.slack.com/join/shared_invite/zt-3932rw936-XNWY1RC8bsffh4if4ZyoXQ#)
- Enterprise Support: SLA-backed support with direct engineer access over email or call