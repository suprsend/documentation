...
description: "Configure the SuprSend CLI to connect to your self-hosted or BYOC deployment by setting up profiles with custom API endpoints and authentication tokens."
keywords:
