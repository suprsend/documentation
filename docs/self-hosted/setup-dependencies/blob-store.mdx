...
description: "Configure private and public object storage buckets on AWS S3, Azure Blob, or Google Cloud Storage for your SuprSend self-hosted deployment assets."
---
