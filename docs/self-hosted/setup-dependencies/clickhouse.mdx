...
description: "Deploy a production ClickHouse cluster on Kubernetes using the Altinity operator with persistence, connectivity tests, and tuning for SuprSend analytics."
---
