...
> **Important**: This section shows only the **Temporal-specific** configuration. You must also configure other required secrets and values for SuprSend to work properly. See the complete configuration guide: [SuprSend Installation Guide](/docs/self-hosted/suprsend-installation-guide)
...
> **Note**: The above configuration goes under `global.config` section in your `suprsend-values.yaml`.
