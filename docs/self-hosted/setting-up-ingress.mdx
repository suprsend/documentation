...
description: "Expose SuprSend APIs and dashboard to the internet by installing the Nginx Ingress Controller on Kubernetes with TLS certificates and routing rules."
---
