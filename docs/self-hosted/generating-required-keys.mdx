...
description: "Generate the deployment secret, NATS NKey pair, and AES cipher keys needed to install SuprSend self-hosted with secure component-to-component encryption."
---
