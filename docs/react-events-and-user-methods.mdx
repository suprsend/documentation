...
description: "Use SuprSend React SDK methods to send events and update user channels, preferences, and properties from your frontend based on in-app user actions."
