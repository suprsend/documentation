---
title: "Send broadcast notifications with the Python SDK"
sidebarTitle: "Broadcast"
description: "Use the SuprSend Python SDK to send broadcast notifications to a list of subscribers, with code examples for setting up the broadcast request and payload."
---
