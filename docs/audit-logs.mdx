---
title: "Audit Logs"
description: "Use SuprSend audit logs to track every action taken by team members in your account, including who changed what, when, for security and team accountability."
---
...
<Frame>
  <img src="/images/audit-logs.png" />
</Frame>

Filter audit logs to find specific entries by:
| Filter option | Description |
|-------|-------------|
| Date range | Choose relative date ranges (for example, last 7 days, last 30 days) or set an absolute date range |
| Actor | Filter by team member email or name |
| Action | Select one or more action types (for example, `account.member_invited`, `api_key.generated`) |
