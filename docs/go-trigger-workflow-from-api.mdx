---
title: "Trigger a workflow from the Go SDK"
sidebarTitle: "Trigger Workflow from API"
description: "Use the SuprSend Go SDK to trigger a workflow directly from your application code, with examples for the workflow payload, recipients, and dynamic data."
---
