---
title: "Send broadcast notifications with the Node.js SDK"
sidebarTitle: "Broadcast"
description: "Use the SuprSend Node.js SDK to send broadcast notifications to a list of subscribers, with code examples for setting up the broadcast request and payload."
---
