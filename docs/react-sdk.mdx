...
<Tip>
**New to SuprSend React SDK?** See how to build a complete task management app with [task board, preference centre, and in-app feed](/docs/task-management-app-guide) in our step-by-step guide.
</Tip>
