...
For platform-specific setup (APNs credentials and entitlement on iOS, `google-services.json` and FCM credentials on Android), see [**Push Setup**](/docs/expo-push-setup).
