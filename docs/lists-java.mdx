---
title: "Lists"
description: "Manage SuprSend subscriber lists with the Java SDK to create or update lists, add and remove users, and trigger bulk notifications and broadcast sends."
---
