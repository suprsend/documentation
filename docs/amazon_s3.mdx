...
<Steps>
  ...
  ## Add your S3 connector details on SuprSend
    ...
    | AWS Key               | This is the access key ID linked to the IAM user. Refer step 4 for steps to create access key                                                                                                                                                                                                                                                                               |
    | AWS Secret            | This is the secret access linked to the IAM user. Refer step 4 for steps to get secret access                                                                                                                                                                                                                                                                               |
