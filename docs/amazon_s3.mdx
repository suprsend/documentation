  ...
  <Steps>
    <Step title="Create S3 Bucket">
      ...
      3. Configure bucket settings:
        - Bucket name: for example:, `suprsend-notification`
    ...
    <Step title="Select the Authentication Scheme">
      ...
      <Accordion title="IAM Role (Recommended)" defaultOpen={true}>
        <Steps>
          ...
          <Step title="Create Policy">
            ...
            * Click on `Next`, and enter a Policy Name (for example: suprsend_trust_role_policy), & other optional Description.
          ...
          <Step title="Create IAM Role">
              ...
              * Enter role name (for example:, `suprsend_trust_role`) and create the role.
          </Step>
      ...
      <Accordion title="IAM User" defaultOpen={false}>
          ...
          1. Create an IAM user with Programmatic access
            - Add relevant user Name: for example:, `s3-bucket-suprsend`
