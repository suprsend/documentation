---
title: "Amazon S3"
description: "Export SuprSend notification data and message templates to your Amazon S3 bucket as parquet and JSON files for warehousing, analytics, and long term storage."
---
...
## How it works?
  ...
  <Frame>
    <img src="/images/data-points-amazon-s3.png" alt="Data Points Parameter on SuprSend Platform" />
  </Frame>
...
## Set up steps
  ...
  <Steps>
    ...
    ## Configure S3 Connector in SuprSend
      ...
      <Frame>
        <img src="/images/docs/3fdddd0-image.png" />
      </Frame>
      ...
      Go to **Settings → Connectors → Amazon S3** and fill in required information.
        ...
        * **In case of IAM Role:**
        <Frame>
          <img src="/images/iam-role-amazon-s3.png" />
        </Frame>

        * **In case of IAM User:**
        <Frame>
          <img src="/images/iam-user-amazon-s3.png" />
        </Frame>
