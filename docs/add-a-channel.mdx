    ...
    <Steps>
      <Step title="Pick a channel">
        ...
        **Standard** and the **Posts** layout.
        ...
        <Frame>
          <img src="/images/add-channel-teams-create-channel.png" alt="Teams Create a channel dialog with Standard channel type and the Posts layout selected" />
        </Frame>
      </Step>
      ...
      <Step title="Open the channel's Workflows menu">
        ...
        <Frame>
          <img src="/images/add-channel-teams-workflows-menu.png" alt="Channel more-options menu in Teams with Workflows highlighted" />
        </Frame>
      </Step>
      ...
      <Step title="Pick the webhook template">
        ...
        <Frame>
          <img src="/images/add-channel-teams-webhook-template.png" alt="Workflows template search for webhook, with Send webhook alerts to a channel highlighted" />
        </Frame>

        Check the team and channel, then **Save**.

        <Frame>
          <img src="/images/add-channel-teams-pick-channel.png" alt="Send webhook alerts parameters with the team and channel selected and a Save button" />
        </Frame>
      </Step>
      ...
      <Step title="Copy the URL">
        ...
        <Frame>
          <img src="/images/add-channel-teams-copy-link.png" alt="Active webhook workflow overview with the Copy webhook link option" />
        </Frame>
