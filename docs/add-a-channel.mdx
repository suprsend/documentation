...
<Tabs>
  ...
  <Tab title="Dashboard">
    **Add the content to your template**
    ...
    <Frame>
      <img src="/images/add-channel-webpush-template.png" alt="Web Push template in the order-shipped editor, with a preview of the rendered Chrome notification" />
    </Frame>
...
<Frame>
  <img src="/images/add-channel-fcm-vendor.png" alt="SuprSend FCM vendor form with fields for nickname, FCM API version, service account key file upload and application package name" />
</Frame>
...
<Tabs>
  ...
  <Tab title="Dashboard">
    ...
    <Frame>
      <img src="/images/add-channel-android-template.png" alt="Android Push template in the order-shipped editor, with a preview of the notification on a device lock screen" />
    </Frame>
...
This guide covers the first two. For a customer's workspace, see the full
