---
title: "Overview"
description: "Overview of SuprSend notification Inbox features, benefits, supported platforms, and links to the live demo and GitHub repository for sample implementations."
---
...
<Card title="Check Live demo in Inbox Playground" href="https://inbox-playground.suprsend.com/">
</Card>
...
- Inbox messages are **completely secure with signed JWT user authentication** to safeguard them from unauthorized access. This means you can use it to send sensitive information related to payments, billing, account updates, etc. Refer the [client authentication guide](/docs/client-authentication) for setup.
