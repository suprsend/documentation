...
description: "Use the SuprSend Android SDK to send and track user events from your app, pass event properties, and trigger notification workflows on real time user actions."
---
