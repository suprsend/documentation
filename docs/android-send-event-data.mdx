...
<CardGroup cols={2}>
  <Card title="Manage Users" icon="user" href="/docs/android-create-user">
    Create users and set communication channels.
  </Card>
  <Card title="FCM Push Setup" icon="bell" href="/docs/android-firebase-fcm-push-integration">
