...
<Frame>
  <img src="/images/categories.png" alt="Notification categories example" width="700" style={{ border: '2px solid #e5e7eb', borderRadius: '8px', padding: '16px', backgroundColor: '#f9fafb', display: 'block', margin: '20px auto', maxWidth: '100%', height: 'auto' }} />
</Frame>
