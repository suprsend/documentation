...
description: "Track and send user events from your Node.js backend using the SuprSend NodeJS SDK to trigger workflows with event properties and code samples."
---
