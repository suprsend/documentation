...
description: "Customization options to adjust the look and feel of In-app feed as per your product designs."
---

Both the [`Inbox`](/docs/react-in-app-feed) (popover) and [`NotificationFeed`](/docs/react-full-screen-or-sidesheet-notifications-feed) (full-screen / sidesheet) components support extensive customization — from simple theme toggles to fully replacing individual sub-components with your own.
...
<CodeGroup>
  ```javascript Inbox
  <Inbox themeType="dark" />
  ```

  ```javascript NotificationFeed
  <NotificationFeed themeType="dark" />
  ```
</CodeGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Full-screen / Sidesheet Feed" icon="sidebar" href="/docs/react-full-screen-or-sidesheet-notifications-feed">
    Render notifications as a full-page or side-panel feed.
  </Card>
