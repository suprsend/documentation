...
description: "Send and track custom events from Go backends using the SuprSend Go SDK to trigger workflows, with method signatures, examples, and event property payloads."
---
