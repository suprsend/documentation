---
title: "Lists"
description: "Manage SuprSend subscriber lists from the Python SDK to create or update lists, add, remove, and replace users, and trigger broadcast notifications to segments."
---
