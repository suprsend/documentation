...
Once you select the button, it will ask for a confirmation. This is just to ensure that a bulk campaigns is not triggered by mistake. Select to trigger the broadcast. You can check the notification status on Logs page.
