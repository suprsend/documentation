...
| Variable data         | _Optional_  | Add variables JSON here if you have variables in your template. **Note:** This data is generic and will be the same for all users in the list. For example: `{"promo_code": "SUMMER2024", "discount": "20%"}` will send the same promo code and discount to every user. For per-user personalization, use user custom properties in your template (see [template variables](/docs/templates#using-variables-in-the-templates)).                                                                                                                                                                                              |
