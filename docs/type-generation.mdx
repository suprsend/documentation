---
title: "Type Safety"
description: "Generate strongly typed interfaces from your SuprSend JSON schemas to catch payload errors at compile time when triggering workflows from your backend code."
keywords:
  - type safety
  - type generation
  - generated types
