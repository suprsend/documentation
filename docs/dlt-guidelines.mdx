...
The Distributed Ledger Technology (DLT) is a Blockchain based technology used by the Telecom Regulatory Authority of India (TRAI) to check for unsolicited SMS's sent to the end users. It was activated as the Telecom Commercial Communications Customer Preference (TCCCP) Regulations in April, 2021. Post these regulations, principal entities (PEs) can only send SMS's which are registered on the Distributed Ledger Technology (DLT) platform.
