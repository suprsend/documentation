...
| `contains`  | Key should be a sub-string or a list item in an array.                                                     |
| `not contains` | Key should not be a sub-string or match any list item in an array.                                   |
...
- An ISO-8601 timestamp ( 2024-03-02T20:34:07Z) which must be a date-time in the future, or
