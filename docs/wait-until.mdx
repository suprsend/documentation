---
title: "Wait Until"
description: "Use the wait until node to pause a workflow until a condition is met or a maximum duration elapses, ideal for delayed reminders and sequential flows."
---
...
<Frame>
  <img src="/images/docs/9d74720a003629bb116ef487a42ee32ecd43b91c70ed5b2e87ff22d666273474-image.png" />
</Frame>
...
| **Tenant** | Tenant properties. These include all properties of the `tenant_id` in your workflow trigger.                                                                                                                                                                | Add as `$tenant.<property_key>`            |
...
<Frame>
  <img src="/images/docs/05a82b6-image.png" />
</Frame>
...
<Frame>
  <img src="/images/docs/3db4e2f-image.png" />
</Frame>
