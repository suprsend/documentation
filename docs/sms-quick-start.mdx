...
<Steps>
  ...
  <Step title="Start testing in Sandbox workspace">
    ...
    * **Sandbox**
       ...
       is setup for quick testing with sample workflow, a sample user with your registered email and pre-configured channels for quick testing. It's ideal for quick exploration and testing and is available for limited period. SMS notifications can only be sent to up to 5 phone numbers to ensure quality testing.

    * **Staging**

       is your development workspace. You'll do all your iterations and testing in this workspace before pushing it to production. You can enable [Test Mode](/docs/developer-tools/test-mode) to safely test without affecting real users.
