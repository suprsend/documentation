---
title: "Preferences"
description: "Step-by-step guide to add a SuprSend notification preference centre to your React website using the SuprSendProvider and preference hooks for opt-in controls."
---
