---
title: "Fullscreen Inbox"
description: "How to integrate SuprSend fullscreen inbox component in Angular, Vue, VanillaJS, and other non-React frameworks."
---
...
This guide helps you integrate drop-in fullscreen feed component (feed without bell) in your non-react frameworks (angular, vuejs, vanillajs etc). If you want to use headless implementation instead of using drop-in components please refer [headless inbox docs](/docs/js-inapp-feed).
...
SDK internally calls `new SuprSend()` when you call `initSuprSend()` then you can access instance using `window.suprsend.client`. This instance has methods like [preferences](/docs/js-preferences), [webpush](/docs/js-webpush), [event and user updates](/docs/js-events-and-user-methods).
...
| [userToken](/docs/client-authentication) | Mandatory when enhanced security mode is on. This is ES256 JWT token generated in your server-side. Refer [authentication docs](/docs/client-authentication) to create userToken.                                            |
...
For further component specific customisations please refer to the [customisation docs](/docs/web-components-customisations).

## Next steps

<CardGroup cols={2}>
  <Card title="Popover Inbox" icon="bell" href="/docs/web-components-popover-feed">
    Add the bell-icon popover inbox component instead.
  </Card>
  <Card title="Customising Feed" icon="paintbrush" href="/docs/web-components-customisations">
    Theme colors, CSS overrides, and custom callbacks.
  </Card>
