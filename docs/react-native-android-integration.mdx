...
description: "Set up the SuprSend React Native SDK on Android with Gradle configuration, package installation, and initialization for push and in-app notifications."
---
