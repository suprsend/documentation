---
title: "Preferences"
description: "Build a notification preference centre in your iOS application using the SuprSend Swift SDK."
---

The SuprSend Swift SDK provides methods to fetch and update user notification preferences. You build the native SwiftUI or UIKit interface — the SDK handles the API calls, optimistic updates, and event-driven sync.
...
<Frame caption="Section with heading, description, and subcategories">
  ![Mobile sections](/images/docs/mobile-sections.png)
</Frame>
...
<Frame caption="Category with name, description, and preference toggle">
  ![Mobile category](/images/docs/mobile-category.png)
</Frame>
...
<CardGroup cols={2}>
  <Card title="Events & User Methods" icon="bolt" href="/docs/ios-events-and-user-methods">
    Track events and manage user properties.
  </Card>
  <Card title="APNS Push" icon="bell" href="/docs/ios-apns-push">
