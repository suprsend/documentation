...
description: "Configure the iOS side of your Flutter app for SuprSend, covering Xcode setup, APNs certificates, capabilities, and push notification entitlements."
---
...
<Steps>
  ...
  <Step title="Change iOS Deployment Target">
    SuprSend SDK needs an iOS deployment target \>= 11. Open your project in Xcode(_project \> ios \> project.xcworkspace_) and update the target.
