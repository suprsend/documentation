---
title: "Lists"
description: "Manage subscriber lists with the SuprSend NodeJS SDK including create, update, add or remove users, replace members, and trigger list broadcasts."
---
