...
**Variables** - personalize with `{{$recipient.name}}`, `{{order_id}}`, `{{$brand.brand_name}}`, etc. Two templating languages: [Handlebars](/docs/handlebars-helpers) (Email, SMS, WhatsApp, Push, Inbox) and [JSONNET](/docs/jsonnet-templates) (Slack, MS Teams).
