---
title: "Trigger Workflows with a Tenant ID for Routing"
description: "Pass a tenant_id when triggering SuprSend workflows or events to apply tenant-level templates, branding, vendors, and delivery rules at send time."
---
