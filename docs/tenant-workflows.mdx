...
description: "Trigger SuprSend workflows and events with a tenant_id to apply tenant-level customization for templates, branding, and delivery in multi-tenant apps."
---
