...
description: "Send events from your backend with the SuprSend Java SDK to trigger workflows, pass event properties, and personalize notifications with code examples."
---
...
Just pass the **tenant_id** of your customer tenant as the **fifth parameter in your event instance** like shown below and the properties of that tenant will be used to replace tenant variables in your template.
