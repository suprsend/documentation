...
4. User preference is`opt-in `for the given channel and preference category (defined in workflow settings). You can check user preference status using [get user preference API](/reference/get-user-category-preferences).
