---
title: "Lists"
description: "Manage SuprSend subscriber lists with the Go SDK to create or update lists, add and remove users, and power bulk notifications and broadcast campaigns."
---
