...
<Steps>
  <Step title="User data (Mandatory for Event-Based Triggers):">
    ...
    **1.1. Setup user sync:**
    ...
    - Users can be updated via [backend SDK](https://docs.suprsend.com/docs/python-manage-users), [frontend SDK](https://docs.suprsend.com/docs/js-events-and-user-methods#update-user-profile), or [direct API calls](https://docs.suprsend.com/reference/create-update-users).
    ...
    **1.2. Migration Process:**
    ...
    - Perform a [one-time bulk migration](https://docs.suprsend.com/docs/python-manage-users#bulk-api-for-handling-multiple-user-profiles) of existing users. Since, profile updates are upsert functions, syncing the same profile again will not create duplicate users.
