---
title: "Use Tenant Variables and Components in Templates"
description: "Reference tenant variables and reusable components inside notification templates so each tenant renders with its own branding, logo, and copy."
---
