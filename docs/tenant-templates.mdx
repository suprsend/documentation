...
description: "Use tenant components and brand variables in SuprSend templates to render tenant-specific content like logos and colors from one shared template at runtime."
---
