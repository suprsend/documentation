---
title: "Angular"
description: "Integration guide to add a SuprSend notification preference centre to your Angular website using the web SDK, including channel and category opt-in controls."
---
...
<div *ngIf="this.preferencesData" class="main-div">
  ...
  <!-- preference category level preferences -->
...
<Frame>
  <img src="/images/docs/3b8ee51-image.png" />
</Frame>
...
<Frame>
  <img src="/images/docs/1742b8c-image.png" />
</Frame>
...
<Frame>
  <img src="/images/docs/a0cf6ad-image.png" />
</Frame>
...
<Frame>
  <img src="/images/docs/5574d6f-channel-update_1.png" />
</Frame>
