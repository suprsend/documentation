...
description: "Integrate the SuprSend NotificationFeed React component to render in-app notifications in a full-screen page or side sheet instead of the default popover."
---
