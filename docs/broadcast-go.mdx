---
title: "Send broadcast notifications with the Go SDK"
sidebarTitle: "Broadcast"
description: "Use the SuprSend Go SDK to send broadcast notifications to a list of subscribers, with code examples for setting up the broadcast request and payload."
---
...
| notification_category | system / transactional / promotional                | You can understand more about them in the [Preference Category](/docs/notification-category).                                                                                                                                                         |
