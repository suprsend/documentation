---
title: "WebPush"
description: "Set up web push notifications in React, Vue, Angular, and Next.js websites with the SuprSend JavaScript SDK including service worker and VAPID config."
---
