...
description: "Understand how SuprSend evaluates user, tenant, and category preferences during workflow runs to decide whether to send each notification through a channel."
---
