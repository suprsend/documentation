...
You can add the ub-category slug in `notification_category` field in your backend workflow call or select the category from dropdown in workflows created through SuprSend dashboard.
