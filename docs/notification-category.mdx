...
* **Setting category-level rules or limits**: For example, you can set a rule that all notifications in promotional category should only be sent between 10AM-5PM or the max notifications in the category should not exceed 100k per day.
