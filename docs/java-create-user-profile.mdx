---
title: "Manage Users"
description: "Create and update user profiles, set channel identifiers like email and phone, and manage subscriber data programmatically with the SuprSend Java SDK."
---
