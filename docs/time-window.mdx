---
title: "Time Window"
description: "Use the time window node to send notifications only within a date range or hours in the user's local timezone, ideal for working hours or weekend-only sends."
---
...
<Frame>
  <img src="/images/docs/8b0c18c-image.png" />
</Frame>
