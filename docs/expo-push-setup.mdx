...
description: "Set up APNs credentials on iOS and FCM with google-services.json on Android to enable native push notifications in your SuprSend Expo SDK app."
---
