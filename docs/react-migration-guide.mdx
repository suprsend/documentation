...
description: "Step-by-step guide to migrate from `@suprsend/react-inbox` to `@suprsend/react`, covering authentication changes, component updates, and toast functionality."
---
