...
description: "Here's a list of supported handlebars helpers that can be used in a template to format data or add conditions on the data passed in workflow trigger."
---
