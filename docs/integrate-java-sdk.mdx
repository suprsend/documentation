...
description: "Install and initialize the SuprSend Java SDK using your workspace key and secret to start sending notifications, managing users, and triggering workflows."
---
