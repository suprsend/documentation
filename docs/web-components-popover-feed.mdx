---
title: "Popover Inbox"
description: "How to integrate SuprSend inbox popover with bell icon in Angular, Vue, VanillaJS, and other non-React frameworks."
---
...
This guide helps you integrate drop-in popover feed component (inbox with bell) in your non-react frameworks (angular, vuejs, vanillajs etc). If you want to use headless implementation instead of using drop-in components please refer [headless inbox docs](/docs/js-inapp-feed).

<Frame caption="Popover inbox with bell icon and notification feed">
...
<CardGroup cols={2}>
  <Card title="Fullscreen Inbox" icon="sidebar" href="/docs/web-components-fullscreen-feed">
    Render notifications in a full-page layout instead of a popover.
  </Card>
