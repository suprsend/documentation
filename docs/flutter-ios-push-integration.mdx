...
### Step 5.1: In Xcode go to File > New > Target.

### Step 5.2: Select Notification Service Extension from the template list.

### Step 5.3: Name your Notification Service
...
### Step 5.4: A folder will be created
...
### Step 5.5: Rename and Run the pod install
...
### Step 5.6: Replace values with your Workspace Key and Workspace Secret.
