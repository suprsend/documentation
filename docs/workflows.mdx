---
title: "Workflow"
description: "Understand what is workflow and how to design a workflow to send multi-channel notification- using triggers, logic steps, branches, and delivery nodes."
---
