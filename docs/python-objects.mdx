---
title: "Objects"
description: "Create, update, and manage SuprSend Objects and their subscriptions from the Python SDK to model teams, organizations, and other non-user entities in code."
---
