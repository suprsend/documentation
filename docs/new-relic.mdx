---
title: "New Relic"
description: "Stream SuprSend notification metrics to New Relic via OpenTelemetry OTLP to monitor API requests, delivery, and engagement with under a minute latency."
---
