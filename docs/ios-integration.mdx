---
title: "Integration"
description: "Install and initialize the SuprSend iOS Swift SDK in your mobile app to enable push, in-app inbox, preferences, and user identification features."
---
...
Already using the SDK on `1.x`? See [Migrating to v2 from v1](/docs/ios-migration-from-v1).
