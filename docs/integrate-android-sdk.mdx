...
Get up and running with the SuprSend Android SDK. This guide covers adding the dependency, initializing the SDK, and configuring your app.
...
<CardGroup cols={2}>
  ...
  <Card title="Track Events" icon="bolt" href="/docs/android-send-event-data">
