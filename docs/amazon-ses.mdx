  ...
  <Step title="Select the Authentication Scheme">
    ...
    <Accordion title="IAM Role" defaultOpen={false}>
        ...
        **Here's how you Create Policy:**
        ...
        3. Either use a 'Visual-editor' or a 'JSON editor' to allow actions ``["ses:SendEmail", "ses:SendRawEmail"]``.
        ...
        5. Enter a Policy Name (e.g. suprsend_trust_role_policy) and optional Description.
