---
title: "In-App Inbox"
description: "Design rich inbox notification cards with action buttons, avatars, pinning, expiry, tags, and dynamic content."
---
...
**Action Buttons** — up to 2 buttons with text + URL. Use for CTAs like "View", "Approve", or inline actions. See [custom click handlers](/docs/react-customising-feed#custom-action-button-click-handlers) for advanced button behaviour.
...
<AccordionGroup>
  ...
  <Accordion title="How do I design an approval / action-required notification?">
    Use **Pin** so the notification stays at the top. Set a short expiry (e.g., 3 days) so stale approvals auto-archive. Use [custom click handlers](/docs/react-customising-feed#custom-action-button-click-handlers) for in-line Approve/Reject without leaving the page.
