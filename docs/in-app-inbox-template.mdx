  ...
  <Step title="Using variables in the templates">
    ...
    <Warning>
      **What happens if there is variable mismatch at the time of sending?**
      ...
      For instance,: if there is an error in rendering Android Push template, but email template is successfully rendered, Android Push notification will not be triggered, but email notification will be triggered by SuprSend.
    </Warning>
  </Step>
</Steps>
