...
<Tip>
  **AI prompt — design an inbox notification:** *"I'm building an in-app inbox notification for [describe use case]. Variables: [list]. Suggest values for SuprSend Inbox fields: Header, Body (Markdown), Avatar, Action buttons, Tags, Expiry, and whether to pin."*
</Tip>
