...
<Steps>
  ...
  <Step title="Start testing in Sandbox workspace" stepNumber="2">
    ...
    - **Sandbox** is setup for quick testing with sample workflow, a sample user with your registered email and pre-configured channels for quick testing. It's ideal for quick exploration and testing and is available for limited period. Email notifications can be sent to up to 5 email addresses to ensure quality testing.
