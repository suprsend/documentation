---
title: "Integration"
description: "Install and initialize the SuprSend iOS Swift SDK in your app, covering CocoaPods or SPM setup, migration from SuprSendSdk, and configuring API keys."
noindex: true
---
