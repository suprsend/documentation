---
title: "Integration"
description: "A step-by-step guide to integrate drop-in inbox / feed in applications like Angular, Vuejs, VanillaJS etc."
---
...
<script>
  ...
  scriptElem.async = 1;
  scriptElem.src = "https://web-components.suprsend.com/v0.2.1/bundle.umd.js";
  scriptElem.onload = () => {
