...
This guide help you integrate drop-in components in your non-react frameworks (angular, vuejs, vanillajs etc). If you want to build your own UI (headless) instead of using drop-in components please refer [docs](/docs/js-inapp-feed).
...
| [userToken](/docs/client-authentication) | Mandatory when enhanced security mode is on. This is ES256 JWT token generated in your server-side. Refer [docs](/docs/client-authentication) to create userToken.                                            |
...
For further component specific customisations please refer to the [docs](/docs/web-components-popover-feed#config-options).
