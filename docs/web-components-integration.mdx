---
title: "Integration"
description: "Integrate the SuprSend inbox and notification feed into Angular, Vue, VanillaJS, and other non-React frameworks using the web components package and JWT auth."
---
