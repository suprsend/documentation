...
description: "Use the remove user from list node to dynamically drop recipients or actors from a SuprSend list during workflow execution based on runtime conditions."
---
