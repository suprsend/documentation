...
description: "Use object subscriptions in SuprSend to link users to objects like teams or projects and notify all subscribed recipients in workflow triggers."
---
...
In nested object hierarchies, a workflow trigger fans out up to two levels by default. This means notifications are sent to Object channels (for example team email, Slack), Object subscribers and Subscribers of child objects.
