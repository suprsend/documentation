...
description: "Use the Subscribe to Object workflow node to dynamically add recipients or actors to an object subscription based on incoming events without custom APIs."
---
