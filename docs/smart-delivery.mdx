...
Routing logic **only applies to outside-app channels** — Email, SMS, WhatsApp, Slack, Push, and similar. SuprSend orders these based on your chosen [optimize-on](#optimize-on) setting (default: lowest to highest cost).
