---
title: "Multi Tabs"
description: "Configure inbox SDK stores and tags to split notifications across multiple tabs like read, unread, archived, or custom categories in your app."
---
...
1. **Add tags in Inbox template**: Go to your Inbox template → **Advanced configuration** → **Tags** section and add the tag (for example, `mentions`). After publishing the template, you can click on the tag to copy it.
...
| categories | Filter notifications based on preference category. Ignore this field to get all notifications irrespective of category.                                                                                                                                                                                |
