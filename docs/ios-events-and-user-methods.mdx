...
description: "Track events and manage user properties in your iOS application using the SuprSend Swift SDK."
---

Use the SuprSend Swift SDK to track user events and manage user properties directly from your iOS app.
...
<CardGroup cols={2}>
  <Card title="Preferences" icon="sliders" href="/docs/ios-preferences">
    Build a notification preference centre in your iOS app.
  </Card>
