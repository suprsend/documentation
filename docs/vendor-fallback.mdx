...
description: "Configure a fallback vendor in SuprSend so notifications retry through a backup provider when the primary SMS, email, or push vendor fails to deliver."
---
