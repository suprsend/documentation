...
<Tip>
**New to SuprSend?** See how to build a complete task management app with inbox notifications, preference centre, and toast notifications in our [step-by-step guide](/docs/task-management-app-guide).
</Tip>
