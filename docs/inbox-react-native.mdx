...
The SuprSend React Native SDK provides headless hooks to build a fully custom notification inbox in your mobile app. You get access to notification data, real-time updates, and action methods — while keeping full control over the UI. See [Feed](/docs/feed-data) for the full notification JSON structure.
...
<CardGroup cols={2}>
  <Card title="Authentication" icon="lock" href="/docs/react-native-authentication">
