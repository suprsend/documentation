...
You can add users or other objects as object subscribers and when a workflow is trigger on the object, SuprSend will automatically fan out and run a workflow for every subscriber on that object. [Learn more about subscription here](/docs/object-subscriptions) .
