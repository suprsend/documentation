...
description: "Learn how to model non-user entities like teams, organizations, and projects with Objects to send group notifications and manage subscribers in SuprSend."
---
...
When you trigger notification on an object, It fans out and sends notifications to the object and all its subscribers. The object acts as an independent recipient of the notification, so if it has two subscribers, the notification will be sent to:
