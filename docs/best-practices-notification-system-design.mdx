...
* **Use Test Mode for safe testing**: Enable [Test Mode](/docs/developer-tools/test-mode) in your workspace to safely test notification flows without delivering to real users. Configure test users for each channel and set up catch-all users to handle unexpected notifications.
