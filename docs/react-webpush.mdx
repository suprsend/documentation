---
title: "WebPush"
description: "Enable browser web push notifications in your React application by configuring SuprSendProvider, VAPID keys, and a service worker for background delivery."
---
...
Please follow this guide to integrate [SuprSendProvider](https://docs.suprsend.com/docs/react-1#suprsendprovider) in your application. Pass `vapidKey` prop to `SuprSendProvider`. You can find it in _`SuprSendDashboard --> Vendors --> WebPush`_.
