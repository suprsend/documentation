...
Variants are evaluated **top to bottom** — the first one whose conditions match is sent. Default is always the fallback. Name them descriptively: `uber-en`, `acme-es`, `default-hi`.
