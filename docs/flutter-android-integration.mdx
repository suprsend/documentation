...
description: "Configure the Android side of your Flutter app for SuprSend, covering Gradle setup, FCM credentials, manifest changes, and push notification handling."
---
