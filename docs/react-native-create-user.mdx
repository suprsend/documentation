...
<Steps>
  ...
  ## Set communication channels
    Mobile Push tokens automatically gets updated in user profile on `suprsend.identify()` call. All you have to do is to integrate [push notification ](/docs/react-native-androidpush-integration)service in your application to start sending mobile push notification. To set other communication channels, use below methods:
