...
<CardGroup cols="4">
  <Card title="Python Backend SDK" icon="python" href="/docs/python-send-track-events">
    
  </Card>
  <Card title="Node Backend SDK" icon="js" href="/docs/node-send-track-events">
    
  </Card>
  <Card title="Java Backend SDK" icon="java" href="/docs/java-send-track-events">
  ...
  <Card title="Kotlin Frontend SDK" icon="android" href="/docs/android-send-track-events">
    (Android)
  </Card>
  <Card title="React Native Frontend SDK" icon="react" href="/docs/react-native-send-track-events">
    (App)
  </Card>
  <Card title="Flutter Frontend SDK" icon="flutter" href="/docs/flutter-send-track-events">
    (App)
  </Card>
