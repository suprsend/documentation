---
title: "Preferences"
description: "Add a notification preference center to React, Vue, Angular, and Next.js websites with the SuprSend JavaScript SDK methods to manage user opt-ins."
---
...
* [Configure preference categories](/docs/user-preferences#setting-up-preference-categories) on SuprSend dashboard
...
<Frame>
  <img src="/images/docs/9204517-full_preferences.png" />
</Frame>
...
1. Category-level preference settings (Sections)
   ...
   * [Category Channel](/docs/js-preferences#13-category-channels-sections---sub-categories---channels)
     ...
     <Frame>
       <img src="/images/docs/4476752-sections.png" />
     </Frame>

2. [Overall Channel-level preference](/docs/js-preferences#2-overall-channel-preferences)

<Frame>
  <img src="/images/docs/3063a30-overallChannel.png" />
</Frame>
...
<Frame>
  <img src="/images/docs/e65f303-section.png" />
</Frame>
...
<Frame>
  <img src="/images/docs/2317beb-subcategories.png" />
</Frame>
...
<Frame>
  <img src="/images/docs/74de834-channelCategory.png" />
</Frame>
...
<Frame>
  <img src="/images/docs/7ffb4c5-overallChannelPref.png" />
</Frame>
...
| --------- | ----------- |
| `tenantId` | Tenant identifier for loading per-tenant preferences. Defaults to the active tenant set in [identify](/docs/integrate-javascript-sdk#authenticate-user) or [changeTenant](/docs/integrate-javascript-sdk#change-active-tenant). Passing it explicitly overrides the active tenant for that call. |
...
If you are passing `tenantId` in preference methods, make sure it matches `scope.tenant_id` passed while creating [userToken](/docs/client-authentication#2-creating-signed-user-jwt-token) else error will be thrown due to scope mismatching.
...
<Frame>
  <img src="/images/docs/90acce7-update1.png" />
</Frame>
...
<Frame>
  <img src="/images/docs/068dbe0-update2.png" />
</Frame>
...
<Frame>
  <img src="/images/docs/a3249bd-update3.png" />
</Frame>
