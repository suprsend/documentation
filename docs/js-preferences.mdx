---
title: "Preferences"
description: "Build a notification preference centre using the headless JavaScript SDK methods."
---

The `@suprsend/web-sdk` provides headless methods to fetch and update user notification preferences. You build the UI — the SDK handles the API calls, optimistic updates, and real-time sync. This guide covers the preference data structure, available methods, and a complete implementation example.
...
<Frame caption="Full preference centre layout">
  ![Full preference centre](/images/docs/9204517-full_preferences.png)
</Frame>
...
<Frame caption="Category-level preference sections">
  ![Category sections](/images/docs/4476752-sections.png)
</Frame>

2. [Overall Channel-level preference](/docs/js-preferences#2-overall-channel-preferences)

<Frame caption="Overall channel-level preferences">
  ![Overall channel preferences](/images/docs/3063a30-overallChannel.png)
</Frame>
...
<Frame caption="Section with heading, description, and subcategories">
  ![Section layout](/images/docs/e65f303-section.png)
</Frame>
...
<Frame caption="Category with name, description, and preference toggle">
  ![Category preferences](/images/docs/2317beb-subcategories.png)
</Frame>
...
<Frame caption="Channel-level checkboxes under each category">
  ![Channel category preferences](/images/docs/74de834-channelCategory.png)
</Frame>
...
<Frame caption="Overall channel preferences with All / Required radio buttons">
  ![Overall channel preferences](/images/docs/7ffb4c5-overallChannelPref.png)
</Frame>
...
<Frame caption="Toggle a category preference on/off">
  ![Update category preference](/images/docs/90acce7-update1.png)
</Frame>
...
<Frame caption="Toggle a channel checkbox within a category">
  ![Update channel in category](/images/docs/068dbe0-update2.png)
</Frame>
...
<Frame caption="Switch a channel between All and Required">
  ![Update overall channel preference](/images/docs/a3249bd-update3.png)
</Frame>
...
For understanding purpose we have added simple example of preferences implementation in React. You could refer this headless example and design the preferences in your Angular or Vue.js etc. If you want to implement in react please refer [@suprsend/react](/docs/preference-react-sdk).
...
<CardGroup cols={2}>
  <Card title="Headless Inbox" icon="code" href="/docs/js-inapp-feed">
    Build a custom notification feed UI with the headless API.
  </Card>
  <Card title="Popover Inbox" icon="bell" href="/docs/web-components-popover-feed">
    Use the drop-in popover inbox component.
  </Card>
  <Card title="Angular Preferences" icon="angular" href="/docs/preferences-angular">
    Angular-specific preference centre implementation.
  </Card>
</CardGroup>