...
Migrating from v1 to v2 has breaking changes, as we have made some architectural level changes. Refer the v1 SDK [documentation](https://docs.suprsend.com/v1.2.1/docs/integrate-javascript-sdk) . Following are changes in detail:
