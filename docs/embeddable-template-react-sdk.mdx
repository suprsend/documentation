...
payload: Dict[str, Any] = {
    ...
    # unique key used to share resources,
    # ex: if you pass tenant_id then resources like designer editor's images will be shared within that tenant.
    # if you pass workspace_uid then resources will shared within that workspace.
    # defaults to organization_uid
    "resource_namespace": "",
    "scope": {
...
| `notificationCategory` | `string`                                | Preference category for triggering test                    | No       | -         |
