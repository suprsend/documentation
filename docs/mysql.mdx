---
title: "MySQL"
description: "Connect your MySQL database to SuprSend to auto sync user cohorts into subscriber lists and trigger broadcast notifications from warehouse data."
---
...
<Frame>
  <img src="/images/docs/f923262-image.png" />
</Frame>
