---
title: "Tenants Quickstart: Multi-Tenant Setup Example"
description: "A minimal working example showing how to create tenants, attach users, and trigger tenant-scoped workflows to ship multi-tenant notifications fast."
---
