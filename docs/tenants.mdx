...
You can programmatically create / update tenant using either one of our backend SDKs ([Python](/docs/python-tenants), [Node](/docs/node-tenants), [Java](/docs/java-tenants), [Go](/docs/tenants-go)) or through SuprSend dashboard. We'll cover the method to create tenant using SuprSend dashboard.
...
3. [Update tenant using java SDK](/docs/java-tenants)
