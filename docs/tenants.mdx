...
- [**Block preference categories**](/docs/tenant-preference#company-setting-preference-for-tenants) - Block certain paid features / modules or channels for a tenant as they have not subscribed to them.
