...
You can programmatically create / update tenant using either one of our backend SDKs ([Python](/docs/python-tenants), [Node](/docs/node-tenants), [Java](/docs/java-tenants), [Go](/docs/go-tenants)) or through SuprSend dashboard. We'll cover the method to create tenant using SuprSend dashboard.
...
4. [Update tenant using go SDK](/docs/go-tenants)
