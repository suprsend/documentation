...
<Frame>
  <img src="/images/docs/ab6f529-Screenshot_2021-10-19_at_4.12.49_PM.png" alt="2482" />
</Frame>

To add other details (subject, from name, from email, reply to and email markup) click on '`Other Email Settings`'.

<Frame>
  <img src="/images/docs/b1145ee-Screenshot_2021-10-20_at_1.27.36_PM.png" alt="1386" />
</Frame>
...
<Steps>
  ...
  <Step title="Using variables in the templates:" stepNumber="2">
    ...
    <Frame>
      <img src="/images/docs/e5ad9be-Screenshot_2021-11-22_at_12.26.23_PM.png" />
    </Frame>
    ...
    <Steps>
      <Step title="Write an Array Object as per the sample below:">
        ...
        <Frame>
          <img src="/images/docs/137de20-c5f7859-Screenshot_2021-11-20_at_6.08.07_PM.png" />
        </Frame>
      </Step>
      ...
      <Step title="Pick a Row of your choice:">
        ...
        <Frame>
          <img src="/images/docs/1bfe489-Screenshot_2021-11-22_at_2.33.08_PM.png" />
        </Frame>
      </Step>
      ...
      <Step title="Select the arrays you want to add:">
        ...
        <Frame>
          <img src="/images/docs/05cb7c2-Screenshot_2021-11-22_at_2.36.16_PM.png" />
        </Frame>
      ...
      <Step title="Select the variables of choice:">
        ...
        <Frame>
          <img src="/images/docs/f9ef60f-Screenshot_2021-11-22_at_2.44.44_PM.png" />
        </Frame>
      </Step>
    </Steps>
...
<Steps>
  <Step title="Add a block and add the relevant content on which you would want to apply the condition." stepNumber="1">
    ...
    <Frame>
      <img src="/images/docs/7d4a897-image.png" />
    </Frame>
  </Step>
  ...
  <Step title="Add the condition in the editor and click on 'Create new condition'" stepNumber="3">
    ...
    * You can add condition in this format `(condition <key> "==" <value>)`. You can use any of the [supported conditional operators](/docs/email-template#supported-conditional-operators) in the conditional statement
    ...
    <Frame>
      <img src="/images/docs/baa3119-Group_20.png" />
    </Frame>
