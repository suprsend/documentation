...
### Create SuprSend account
  ...
  ### Create MS Teams App
    To activate MS Teams Integration, you'll have to [create a Teams App](/docs/microsoft-teams#create-teams-app) and [add integration in SuprSend vendor page](/docs/microsoft-teams#add-teams-integration-on-suprsend).
