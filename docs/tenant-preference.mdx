---
title: "Configure Tenant-Level Notification Preferences"
description: "Set up tenant-level notification category preferences in SuprSend so users in each tenant inherit defaults that match the brand's communication rules."
---
