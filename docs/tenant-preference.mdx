...
<CardGroup cols="2">
  ...
  <Card title="Via Dashboard" icon="grid" iconType="solid">
    Configure from the <a href="https://app.suprsend.com/en/staging/tenants/default/tenant_preference">tenant details page</a>
  </Card>
</CardGroup>
...
<Tabs>
  <Tab title="Platform Admin Actions">
    - Turning off categories or channels for a tenant from the [tenant preference page](https://app.suprsend.com/en/demo/tenants/default/tenant_preference) automatically removes them from the tenant's preference view
