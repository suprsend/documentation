...
description: "Browse Messagebird SMS error codes returned during vendor delivery, with descriptions and resolution steps you can follow to fix failed sends."
---
