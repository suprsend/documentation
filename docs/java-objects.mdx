---
title: "Objects"
description: "Create, update, and manage non-user objects and their channel subscriptions in SuprSend using the Java SDK for teams, accounts, devices, and more."
---
