---
title: "Delay"
description: "Use the delay node in SuprSend workflows to pause execution for a fixed, dynamic, or specific time before moving to the next step for reminders and follow ups."
---
...
<AccordionGroup>
  <Accordion title="Fixed">
    Fixed delay is defined in your workflow form as `xxd xxh xxm xxs` and it delays the workflow for a fixed duration for all users.

    <Frame>
      <img src="/images/docs/9f1be88-image.png" />
    </Frame>
  ...
  <Accordion title="Dynamic">
    ...
    <Frame>
      <img src="/images/docs/39e61b1-image.png" />
    </Frame>
  ...
  <Accordion title="Relative">
    ...
    Dynamic Interval & Timestamp must be passed as a JQ expression. Examples:
