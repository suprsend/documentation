...
description: "Dynamically Add users to list or remove them, within a workflow."
---

within a workflow, enabling event-based user segmentation and automated messaging through SuprSend.
