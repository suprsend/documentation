---
title: "Branch"
description: "Add conditional logic to your workflow using Branch. Route notifications through different paths based on user, tenant, or payload conditions."
---
