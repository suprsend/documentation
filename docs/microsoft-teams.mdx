...
<Steps>
  ...
  <Step title="Add Bot">
    Now select App feature from your left panel to click on Bot. If you have an existing bot, select it from the list or click on Create a new bot On the [bot page](https://dev.teams.microsoft.com/bots), click on **\+New Bot** and add bot name. Add a relevant bot name and **Add**.
