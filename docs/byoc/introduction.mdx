...
<Info>
**Enterprise only.** BYOC (Bring Your Own Cloud) and self-hosted deployment are available only for SuprSend **enterprise customers**. Contact your account team or [enterprise-support@suprsend.com](mailto:enterprise-support@suprsend.com) for access.
</Info>

SuprSend gives you the option to run the full notification infrastructure in your own VPC or on-premises environment. Self-hosted deployment keeps your data in your control while delivering the same capabilities as SuprSend Cloud: multi-channel delivery, [preferences](/docs/user-preferences), [workflows](/docs/workflows), and [templates](/docs/templates). You own both the control plane and the data plane.

Once deployed, you use the same [SuprSend dashboard](https://app.suprsend.com/en/login), APIs, and product concepts as in the main documentation — the only difference is where the services run.
...
<Frame caption="SuprSend deployment options: SaaS, BYOC, and Self-Hosted">
  <div style={{textAlign: 'center'}}>
    <img src="/images/byoc/deployment-modes.png" alt="SuprSend Deployment Modes" style={{maxWidth: '100%', height: 'auto', borderRadius: '8px'}} />
  </div>
</Frame>
...
Track all self-hosted releases in the [BYOC Changelog](/docs/byoc/changelog).
