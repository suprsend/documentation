---
title: "Create and Manage Tenants with the Java SDK"
description: "Create, update, fetch, list, and delete tenants programmatically using the SuprSend Java SDK to power multi-tenant notification flows in your backend."
---
