...
<Info>
  This is v3 of `suprsend_flutter_sdk`. Documentation for v2 of this SDK is available [here](https://github.com/suprsend/suprsend-flutter-sdk-old/tree/main/docs). If you are upgrading from v2, refer the [migration guide](/docs/flutter-migration-from-v2).
</Info>
