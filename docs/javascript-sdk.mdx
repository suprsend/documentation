...
<Steps>
  ...
  <Step title="Authenticate User">
    ...
    **Returns:** `Promise<ApiResponse>`
    ...
    This method will check if user is authenticated that is, `distinctId` is attached to SuprSend instance. To check for userToken also pass checkUserToken flag true.
