...
description: "Show toast notifications in your React app when new in-app messages arrive using the feed.new_notification event listener from the SuprSend SDK."
---
