...
<Steps>
  ...
  <Step title="Integrate Inbox in your product">
    ...
    | React Native (Mobile App)                                                                  | [link](/docs/https://github.com/suprsend/suprsend-react-inbox/blob/main/docs/intergration.md-native) | [https://codesandbox.io/s/suprsend-react-headless-example-qkxobd?file=/src/App.tsx](https://codesandbox.io/s/suprsend-react-headless-example-qkxobd?file=/src/App.tsx) |
