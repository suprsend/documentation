...
3. **Can't Unsubscribe**: Prevents users from fully opting out of the category. When selected, you can configure:
   - **Mandatory Channels**: Channels that always send (users can't unsubscribe). Set to "All" or "Selected Channels only"
   - **Non-mandatory channels**: Choose which channels default to "On". Users can opt out of these. Set to "All" or "Selected Channels only"
