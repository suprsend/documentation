...
- **Transactional**: Notifications related to user transactions on your platform, such as payment confirmations, delivery statuses, and comments.
- **Promotional**: Marketing notifications like newsletters, announcements, deals, and discounts.

### Set default preferences

If the user hasn't set preferences in a category, SuprSend sends notifications based on default preferences. Default preferences are set from [Developers -> Preference categories](/docs/notification-category#default-preferences) page or via [preference management API](/reference/create-update-category). Tenant can override the default preferences for their users, either through the [tenant preference API](/reference/update-tenant-default-preference) or from the tenant details page.
<br/>
**Order of precedence for preference evaluation**<br/>
```User Preference > Tenant Default Preference > Default Preference set at category level```
<br/>
