...
<Frame>
  {/* SCREENSHOT NEEDED: broadcast-logs.png — the Messages log filtered to this broadcast, showing the status counts down the left and one expanded row with its Triggered / Delivered timeline */}
  <img src="/images/broadcast-logs.png" alt="The Messages log for a broadcast, showing per-recipient rows and the status filters" />
</Frame>
