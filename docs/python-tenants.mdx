---
title: "Tenants"
description: "Use the SuprSend Python SDK to create, update, fetch, and list tenants for white-labelled notifications and per-tenant template content."
---
...
| Field                                          | Description                                                                                                                                                                |
| ---------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| tenant_id (mandatory)                          | Unique identifier for the tenant (max 64 characters, case insensitive). It can contain lowercase letters (a-z), digits (0-9), dot (.), hyphen (-), and underscore (\_) — matching `[a-z0-9_.-]`. |
