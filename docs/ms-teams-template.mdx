...
description: "How to design simple MS Teams template using markdown editor or use JSONNET editor to replicate Microsoft's adaptive card design."
---
...
<Frame>
  <img src="/images/docs/a647239-image.png) Enter the variables in `JSON` format as shown in the screenshot below. This JSON should be the same as passed in your workflow or event request (it is a part of the `data` field for workflow and `properties` field for event). ![](/images/docs/d055e38-image.png" />
</Frame>
...
<Frame>
  <img src="https://files.readme.io/d7495e4-ezgif.com-optimize.gif" />
</Frame>
...
<Frame>
  <img src="/images/docs/a647239-image.png) Enter the variables in \`JSON\` format as shown in the screenshot below. This JSON should be the same as passed in your workflow or event request (it is a part of the \`data\` field for workflow and \`properties\` field for event). ![](/images/docs/6081f15-image.png" />
</Frame>
