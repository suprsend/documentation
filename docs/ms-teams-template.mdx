...
<Note>
  To send MS Teams notifications, start from [Microsoft Teams](/docs/microsoft-teams) and save app credentials on the vendor from [Create a Teams app](/docs/microsoft-teams-create-app). That includes webhook sends.
</Note>
