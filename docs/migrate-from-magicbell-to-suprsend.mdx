...
Inbox Implementation in SuprSend is similar to Magicbell. Though, we take security quite seriously and HMAC authentication is a must for subscriber authentication in SuprSend. You can quickly implement it using customizable [drop-in react components](https://github.com/suprsend/suprsend-react-inbox/blob/main/docs/intergration.md) or have your custom implementation with [headless library](https://github.com/suprsend/suprsend-react-inbox/blob/main/docs/headless.md).
