...
<Frame caption="Template editor — channel tabs, toolbar, and preview">
...
<Frame caption="Commit — review changes before publishing">
...
<Warning>
  Tests use the **live version** — commit first, then test. For WhatsApp and SMS in India (carrier approval), the template must be approved before you can test.
</Warning>
...
<Frame caption="Variants — one template, multiple audiences (see Template Variants for the full guide)">
  <img src="/images/docs/templates-variants-panel-full.png" alt="Template editor All Variants panel with default and conditional variants" />
</Frame>

**Languages** — need translations or locale-specific layouts? See [Localisation](/docs/templates#localisation) in [Templates](/docs/templates) (translation files vs language variants).
...
<CardGroup cols="3">
  ...
  <Card title="SMS" icon="comment-sms" iconType="solid" href="/docs/sms-template">
    Single text field. Carrier approval for India.
  </Card>
