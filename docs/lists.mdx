---
title: "Manage Lists"
description: "Create and manage SuprSend subscriber lists from the dashboard to group users, run bulk notifications, send broadcasts, and target marketing campaigns."
---
...
<Accordion title="Using third party data platforms">
  ...
  Need support for another connector? [Let us know](https://join.slack.com/t/suprsendcommunity/shared_invite/zt-3932rw936-XNWY1RC8bsffh4if4ZyoXQ)
</Accordion>
