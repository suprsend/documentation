---
title: "WhatsApp"
description: "Design WhatsApp notification templates with header, body, footer, and buttons - with Meta approval and a live conversation preview."
---
...
<Frame caption="WhatsApp editor with live device preview">
  ![](/images/docs/templates-editor-whatsapp.png)
</Frame>
...
<Frame caption="WhatsApp Call to Action button configuration">
  ![](/images/docs/templates-editor-whatsapp-buttons.png)
</Frame>
...
<Tip>
  **AI prompt - check approval likelihood:** _"Review this WhatsApp template for Meta approval. Category: \[UTILITY/MARKETING/AUTHENTICATION\]. Header: \[text\]. Body: \[paste\]. Footer: \[text\]. Buttons: \[describe\]. Check category match, prohibited content, variable placement, character limits, and formatting. Suggest fixes."_
</Tip>
