...
description: "Use the update user profile node to set attributes, channels, or properties on a recipient inside a workflow based on events, conditions, or fetched data."
---
...
<Frame>
  <img src="/images/docs/f7bdefc09935b99e8d955213f0d7eab3c93701796aa6f9a6a8e96567ca8135cd-image.png" />
</Frame>
...
| Tenant | pass as`data["$tenant"].<property_key>`     | Tenant properties corresponding to the tenant\_id passed in workflow trigger.                                                                                                                                                |
