---
title: "InApp Feed"
description: "This guide explains to integrate SuprSend’s InApp feed in non-React apps using headless SDK methods—fetch, listen, and manage notification states."
---
