---
title: "Service Token"
description: "Create and rotate Service Tokens to authenticate SuprSend Management API requests and securely automate deployments from CI and scripts."
---
...
3. Provide a **descriptive name** (for example, `staging-to-prod-promotion`).  
