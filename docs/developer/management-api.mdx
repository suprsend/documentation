...
description: "Use the SuprSend Management API to programmatically create, version and deploy templates, workflows and notification assets across workspaces."
---
