...
<Update label="27 Aug 2024">
  ...
  E.g., in a booking reminder workflow, if a user has multiple bookings, you can now match the booking ID of a cancellation event with the original event to ensure correct reminder gets canceled.
